...
QString mainVersion = "0.1";
QString version = "0.1.1802";
...
void MainForm::about()
{
	QMessageBox::about(this, tr("Password keeper"), tr("<h2>Password keeper %1</h2><br>This is a free, small program to save your passwords for mail, forums, etc.<br>Used crypto algorithms: MD2, RC4<br><a href=mailto:piton3000@rambler.ru>piton3000@rambler.ru</a><br>Copyright &copy; piton, MIPT, 2006<br><br>Version: %2").arg(mainVersion).arg(version) );
}
...
void MainForm::languageChange()
{
    ...
    openProfileAction->setStatusTip( tr("Opens your data") );
    ...
    tb_openProfileAction->setStatusTip( tr("Opens your data") );
    ...
    closeProfileAction->setStatusTip( tr("Closes your data") );
    ...
    tb_editDeleteField->setStatusTip( tr("Deletes a selected field") );
    editDeleteAll->setText( tr("Delete all") );
    editDeleteAll->setMenuText( tr("Delete &all") );
    editDeleteAll->setStatusTip( tr("Deletes all fields, not profile") );
